...
export default function Hero() {
  ...
  return (
    <div className="relative min-h-screen bg-[#1C1C1C] overflow-hidden">
      ...
      <div
        ref={topRightTagRef}
        className="fixed top-24 right-8 z-50 font-mono text-sm bg-[#2A2A2A]/90 
      ...
      <div
        ref={topLeftTagRef}
        className="fixed top-24 left-8 z-50 font-mono text-sm bg-[#2A2A2A]/90 
                 text-gray-300 px-4 py-2 rounded-lg border border-gray-700/50 
                 shadow-[0_0_15px_rgba(0,0,0,0.3)] backdrop-blur-sm
                 transition-all duration-200 ease-out cursor-pointer"
      >
      ...
      <div
        ...
        className="fixed bottom-8 left-8 z-50 font-mono text-sm bg-[#2A2A2A]/90 
                 text-gray-300 px-4 py-2 rounded-lg border border-gray-700/50 
                 shadow-[0_0_15px_rgba(0,0,0,0.3)] backdrop-blur-sm
                 transition-all duration-200 ease-out cursor-pointer"
      >
      ...
      <div
        ...
        className="fixed bottom-8 right-8 z-50 font-mono text-sm bg-[#2A2A2A]/90 
                 text-gray-300 px-4 py-2 rounded-lg border border-gray-700/50 
                 shadow-[0_0_15px_rgba(0,0,0,0.3)] backdrop-blur-sm
                 transition-all duration-200 ease-out cursor-pointer"
      >
      ...
      <nav className="fixed top-0 left-0 right-0 z-50">
        <div className="mx-auto px-6 py-4">
          <div className="backdrop-blur-md bg-[#1C1C1C]/40 rounded-2xl 
